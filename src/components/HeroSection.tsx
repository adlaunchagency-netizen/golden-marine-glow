...
import productImage from "@/assets/neo-collagen-product.png";
...
const HeroSection = () => (
  <section className="relative min-h-screen flex items-center pt-20 overflow-hidden bg-dark-bg">
    ...
    <div className="container grid md:grid-cols-2 gap-8 md:gap-12 items-center relative z-10">
      {/* Text - appears first on mobile, second on desktop (RTL) */}
      <motion.div
      ...
      >
        ...
        <a
          href="#order"
          className="bg-gold-gradient text-dark-bg font-body text-base font-bold px-10 py-4 rounded-xl hover:opacity-90 transition-opacity inline-block min-h-[56px] flex items-center justify-center w-full sm:w-auto"
        >
      ...
      >
        <img
          ...
          width={800}
          height={1024}
          className="w-56 sm:w-64 md:w-72 lg:w-80 drop-shadow-[0_20px_60px_rgba(201,151,42,0.3)]"
        />
      </motion.div>
    </div>

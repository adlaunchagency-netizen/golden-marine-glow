...
const faqs = [
  {
    q: "واش هذا المنتج آمن للاستخدام؟",
    a: "نعم. Paravita Neo Collagen مصنوع من مكونات طبيعية 100%، مستخلص من أسماك برية، بدون مواد كيميائية أو حافظات. يُنصح باستشارة الطبيب إذا كنتِ حاملاً أو ترضعين أو تتناولين أدوية.",
  },
  {
